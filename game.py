...
MAX_HEIGHT = 800
score = 0
BIRDS_IMGS = [pygame.transform.scale2x(pygame.image.load(os.path.join("img", "bird1.png")), ),
...
def draw_window(win, birds, pipes, base, score):
    ...
    win.blit(text, (MAX_WIDTH - 10 - text.get_width(), 10))
    base.draw(win)
    for bird in birds:
        bird.draw(win)
...
def main(genomes, config, score=score):
    global add_pipe
    nets = []
    ge = []
    birds = []
